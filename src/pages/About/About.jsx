...
const About = () => {
    return (
        <Container>
            <div className='m-3'>
                <Row className='d-flex' xs={1} md={2}>
                    <Col>
                        <img className='w-75 my-5' src="https://i.ibb.co/0sdg4tz/Chef-Special-Salad-Discount-Instagram-Advertisement-Post.png" alt="" />
                    </Col>
                    <Col xs={8}>
                        <h2 className='fw-bold border-bottom my-5'>The Chefs Cafe</h2>
