...
const RecipeCard = ({recipe}) => {
    const {recipe_id, picture, name, short_bio, recipe_name, likes, banner, ingredients, cooking_method, years_of_experience, num_recipes} = recipe;
            ...
            <Card className="text-center mb-4">
                ...
                <Card.Footer className="text-muted">
                    <Row className='d-flex flex-column justify-content-center'>
                        <Col>
                            <Button onClick={() => setShow(true)}><small><FaHeart />{' '}Likes: {' '}{likes}</small></Button>
                        </Col>
                        <Col className='mt-3'>
